...
class ReadMoreText extends StatefulWidget {
  const ReadMoreText(
    this.data, {
    Key? key,
    this.trimExpandedText = StringHelper.readLess,
    this.trimCollapsedText = StringHelper.readMore,
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    // TextSpan link = widget.customOnTap != null
    //     ? TextSpan(
    //         text:
