...
class UpComingEventActivity extends StatefulWidget {
  final List<UpcomingJoinedEventList>? upcomingCarnival;

  UpComingEventActivity({this.upcomingCarnival});
...
class _UpComingCarnivalState extends State<UpComingEventActivity> {
  @override
  void initState() {
    super.initState();
  }
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: DimensHelper.smallSides),
                        child: Text(carnivalData.carnivalTitle.toString(),
                            style: TextStyle(
        ...
        title: Stack(
          children: [
            ...
            Container(
              ...
              child: Text(StringHelper.upComingEvents.toUpperCase(),
